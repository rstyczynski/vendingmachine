# ═══════════════════════════════════════════════════════════════
# Custom Variable Proxy Layer: APP1 Compute Instances
# 
# This file is OPTIONAL. If this file exists, it will override the
# default var2hcl logic from app1_compute.tf
# ═══════════════════════════════════════════════════════════════

locals {
  # Custom proxy layer: Transform APP1 compute instance variables into locals
  # This will override the default var2hcl logic from app1_compute.tf
  # 
  ...
  app1_compute_instances_var2hcl_custom = {
