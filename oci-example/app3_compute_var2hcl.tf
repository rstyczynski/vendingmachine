# ═══════════════════════════════════════════════════════════════
# Variable Proxy Layer: APP3 Compute Instances
...
locals {
  ...
  # Custom var2hcl logic (optional - defined in app3_compute_var2hcl_custom.tf if needed)
  # If app3_compute_var2hcl_custom.tf exists, it should define app3_compute_instances_var2hcl_custom_override
  # which will override the default. If not defined, an empty map is used.
  app3_compute_instances_var2hcl_custom_override = try(
    local.app3_compute_instances_var2hcl_custom_override,
    {}
  )

  # Final var2hcl: Use custom override if provided, otherwise use default
  app3_compute_instances_var2hcl = length(local.app3_compute_instances_var2hcl_custom_override) > 0 ? local.app3_compute_instances_var2hcl_custom_override : local.app3_compute_instances_var2hcl_default
}
