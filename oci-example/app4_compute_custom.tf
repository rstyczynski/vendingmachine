# ═══════════════════════════════════════════════════════════════
# Custom Variable Proxy Layer: APP4 Compute Instances
# 
# This file is OPTIONAL. If this file exists, it will override the
# default var2hcl logic from app4_compute.tf
# ═══════════════════════════════════════════════════════════════

locals {
  # Custom proxy layer: Transform APP4 compute instance variables into locals
  # This will override the default var2hcl logic from app4_compute.tf
  # 
  ...
  app4_compute_instances_var2hcl_custom = {
