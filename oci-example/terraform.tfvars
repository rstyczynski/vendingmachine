...
# ═══════════════════════════════════════════════════════════════
# APP3 Compute Instances Configuration
# ═══════════════════════════════════════════════════════════════

app3_compute_instances = {
  "instance://vm_demo/demo/app3_instance" = {
    zone = "zone://vm_demo/demo/app" # Zone map key reference (for subnet, AD)
    
    nsg  = ["nsg://vm_demo/demo/demo_vcn/ssh"] # NSG FQRN list (co-resource) - can reference any app NSGs
...
log_groups = {
  "log_group://vm_demo/demo/demo_log_group" = {
